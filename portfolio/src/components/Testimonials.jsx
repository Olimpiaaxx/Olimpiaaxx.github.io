...
import 'src/components/Testimonials.scss';
...
const testimonials = [
  ...
  },
  {
    ...
    testimonial: `Olimpia has been an asset to our team and a joy to work with these past couple of years. Her work ethic is both efficient and resourceful and she really thrives when it comes to undertaking challenges outside of her remit, pushing the boundaries of her comfort zone in pursuit of learning, knowledge and growth. 
    She’s a confident individual, who enjoys working autonomously, but she’s also an active team player, wanting to improve team productivity, code practices and product potential. 
    I’m glad to have had the privilege to work with Olimpia; I have no doubt that she’ll go far in her career.`
...
export const Testimonials = () => {
    ...
    const displayNextTestimonial = () => {
      setCurrentIndex((currentIndex + 1) % totalSlides);
    };
  
    const displayPrevTestimonial = () => {
      setCurrentIndex((totalSlides + currentIndex - 1) % totalSlides);
    };
      ...
      >
        <div className="container">
          <div className="testimonial-card">
            ...
            <h6 className="job">{testimonials[currentIndex].job}</h6>
          </div>
          <div className="button-container">
            <button className="button" onClick={displayPrevTestimonial}>
              Previous
            </button>
            <button className="button" onClick={displayNextTestimonial}>
              Next
            </button>
          </div>
        </div>
